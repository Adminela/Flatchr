# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            'ks_dashboard_ninja/static/src/js/*.js',
            'ks_dashboard_ninja/static/src/css/*',
            'ks_dashboard_ninja/static/lib/js/*.js',
            'ks_dashboard_ninja/static/lib/css/*.css',
        ],
        'web.assets_qweb': [
            'ks_dashboard_ninja/views/ks_dashboard_ninja_assets.xml',
